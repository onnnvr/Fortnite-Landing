...
export default function LastSection() {
    return (
        <section className="w-screen overflow-hidden bg-black py-20 ">
            <div className="mx-auto container px-5 lg:px-40 flex flex-col items-center gap-30">
